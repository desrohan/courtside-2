...
import { useSettingsContext } from "@/pages/ui-component/components/settings";
...
export default function ThemeProvider({ children }: Props) {
	...
	const currentThemeMode = settings.themeMode || "light";
	const darkModeOption = darkMode(currentThemeMode);
